  ...
  def self.insert_ke30x(vtweg, perio)
    ...
    sql = "
      insert into tmplum.ke30x
        select a.vtweg,a.perio,a.budat,a.kndnr,a.artnr,a.kaufn,a.kdpos,b.vgbel,b.vgpos,b.vbeln,b.posnr,b.charg,b.fkimg,b.vrkme,a.vvr10,
    ...
    sql = "
      insert into tmplum.aufkx
        select a.aufnr,b.stat,b.chgnr,0 bomlv,' ' xstat, ' ' xdate, ' ' xtime
          from sapsr3.aufk a
